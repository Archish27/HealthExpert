...
dirty_dataset.to_csv('clean_dataset.csv', columns=header, index=False)
# with open("clean_dataset.csv", 'r') as f:
#     with open("final_dataset.csv", 'w') as f1:
#         f.readline()  # skip header line
#         for line in f:
#             f1.write(line)

with open("clean_dataset.csv", "r", encoding='utf-8') as infile, open("final_dataset.csv", "w",
